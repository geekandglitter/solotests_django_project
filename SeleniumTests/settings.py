...
# BASE_DIR: Always needed in settings. Build paths inside the project like this:
# os.path.join(BASE_DIR, ...)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # this line is always needed
# in settings.py. It shows where manage.py is.
...
SECRET_KEY = 'nqg(45%(tx*zb31mppw*0d1hij+vy2dlod3o@g$)xj6oe98sv5'
